...
interface Osmosis {
    new(url:string, params?: any | {}): Osmosis;
     ...
     * find DOM by selector
     */
    filter(selector: string): Osmosis;
     ...
     * result data, osmosis finished
     */
    rawcallback(callback: (context: any, data: any) => any): Osmosis;
     ...
     * Set configuration options for the **preceeding** command on down the chain.
     */
    preconfig(option: string | { [key: string]: any }, value?: any): Osmosis;
